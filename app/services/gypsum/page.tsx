      ...
      <main className="flex-grow pt-20">
        <section className="relative bg-dark-primary text-white py-20">
          <div className="absolute inset-0 opacity-30">
            <Image 
              src="/images/uploaded/img48.jpeg"
              alt="جبس بورد الرياض"
              fill
          ...
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
                <Image src="/images/uploaded/img49.jpeg" alt="أسقف جبس بورد" fill className="object-cover"  />
                <div className="absolute bottom-0 left-0 right-0 bg-black/60 text-white p-4 font-bold">أسقف معلقة وإضاءة مخفية</div>
              </div>
              <div className="relative h-64 rounded-xl overflow-hidden shadow-md">
                <Image src="/images/uploaded/img50.jpeg" alt="ديكورات جدارية" fill className="object-cover"  />
